  ...
  def main(self):
    ...
    while not self.shutdown:
      try:
        ...
        print ("%s" % hexlify(struct.pack("B", 1) + job.midstate[::-1] + job.data[75:63:-1]).decode("ascii"))
    ...
    try:
      ...
      while True:
        ...
        if result == 1:
          ...
          print ( "citam bytes: %s" % hexlify(self.handle.read(300)[::]).decode("ascii"));
          nonce = 0x32A35A4B;
